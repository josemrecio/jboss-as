...
public class JBossConvergedSipMetaData extends JBossWebMetaData {
    ...
    public void merge(JBossWebMetaData override, SipMetaData original, String overrideFile, String overridenFile,
            boolean mustOverride) {
        // FIXME: merge super.merge(override, original);
        ...
        if (override != null && override.getSecurityConstraints() != null)
            setSecurityConstraints(override.getSecurityConstraints());
        ...
        // FIXME: merge getSipSecurityRoles().merge(overrideRoles, originalRoles);
        ...
        /*
         * FIXME: merge setSipMessageDestinations(MessageDestinationsMetaData.merge(overrideMsgDests, originalMsgDests,
         * overridenFile, overrideFile));
         */
        if (getSipMessageDestinations() == null) {
            setSipMessageDestinations(overrideMsgDests);
        }
        ...
        // FIXME: merge ((JBossEnvironmentRefsGroupMetaData)getJndiEnvironmentRefsGroup()).merge(jenv, env, null, overrideFile,
    ...
    public void merge(JBossConvergedSipMetaData override, SipMetaData original, String overrideFile, String overridenFile,
            boolean mustOverride) {
        // FIXME: merge super.merge(override, original);
        ...
        if (override != null && override.getDescriptionGroup() != null)
            setDescriptionGroup(override.getDescriptionGroup());
        else if (original != null && original.getDescriptionGroup() != null)
            setDescriptionGroup(original.getDescriptionGroup());
         ...
         */
        if (getSipMessageDestinations() == null) {
            setSipMessageDestinations(originalMsgDests);
        }
