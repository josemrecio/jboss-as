 ...
 * @author Stan Silvert
 */
public class WarClassloadingDependencyProcessor extends AbstractDeploymentProcessor {

    protected static final ModuleIdentifier JAVAX_EE_API = ModuleIdentifier.create("javaee.api");

    protected static final ModuleIdentifier JSF_IMPL = ModuleIdentifier.create("com.sun.jsf-impl");
    protected static final ModuleIdentifier JSF_API = ModuleIdentifier.create("javax.faces.api");
    protected static final ModuleIdentifier JSF_1_2_IMPL = ModuleIdentifier.create("com.sun.jsf-impl", "1.2");
    protected static final ModuleIdentifier JSF_1_2_API = ModuleIdentifier.create("javax.faces.api", "1.2");
    protected static final ModuleIdentifier BEAN_VALIDATION = ModuleIdentifier.create("org.hibernate.validator");
    protected static final ModuleIdentifier JSTL = ModuleIdentifier.create("javax.servlet.jstl.api");

    protected static final ModuleIdentifier JBOSS_WEB = ModuleIdentifier.create("org.jboss.as.web");
    ...
    protected void addJSFAPI(String jsfVersion, ModuleSpecification moduleSpecification, ModuleLoader moduleLoader) {
    ...
    protected void addJSFImpl(String jsfVersion, ModuleSpecification moduleSpecification, ModuleLoader moduleLoader) {
        if (jsfVersion.equals(JsfVersionMarker.WAR_BUNDLES_JSF_IMPL)) return;
